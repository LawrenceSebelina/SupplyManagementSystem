...
<head>
    ...
    <meta name="title" content="J.F Rubber Phils., Inc">
    <meta name="description" content="This is a medical HTML template">
    ...
    <section class="header-section">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark"> <!-- bg-body-tertiary  -->
                    <div class="container-fluid px-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarIconMenu">
                            ...
                            <a class="btn btn-green" href="#" role="button">Log In</a>
        ...
        <div class="banner-content">
            <div class="container">
                ...
                <h1 class="headline-lg"><span>J.F. RUBBER</span> PHILS., INC.</h1>

                <p class="paragraph-text">At J.F. Rubber, we collaborate with accredited vendors to create rubber parts that meet your specifications. We ensure quality at every stage of the process, from raw materials to finished goods.
                </p>

                <a class="btn btn-green" href="#" role="button">Visit Us To Know More</a>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-1.png" alt="vision-img">
                        </div>
                    ...
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-2.png" alt="vision-img">
                        </div>
                    ...
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-3.png" alt="vision-img">
                        </div>
                    ...
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-4.png" alt="vision-img">
                        </div>
                    ...
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-5.png" alt="vision-img">
                        </div>
                    ...
                    <div class="col-md-4 mb-auto">
                        <div class="container product-container">
                            <img class="img-fluid" src="img/product-6.png" alt="vision-img">
                        </div>
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="img/carousel-bg2 1.png" class="d-block w-100 img-fluid" alt="carousel-img-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/carousel-bg 1.png" class="d-block w-100 img-fluid" alt="carousel-img-2">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/carousel-bg3 1.png" class="d-block w-100 img-fluid" alt="carousel-img-3">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h2 class="headline-sm text-light">Company Background</h2>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-red" data-bs-dismiss="modal"><i class="fa fa-solid fa-xmark fa-xl"></i> Close</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 core-value">
                        <img class="img-fluid" src="img/core-value-1.svg" alt="commitment-img">
                        <h3 class="mt-4">Commitment</h3>
                    </div>
                    <div class="col-md-3 core-value">
                        <img class="img-fluid" src="img/core-value-2.svg" alt="team-work-img">
                        <h3 class="mt-4">Team Work</h3>
                    </div>
                    <div class="col-md-3 core-value">
                        <img class="img-fluid" src="img/core-value-3.svg" alt="integrity-img">
                        <h3 class="mt-4">Integrity</h3>
                    </div>
                    <div class="col-md-3 core-value">
                        <img class="img-fluid" src="img/core-value-4.svg" alt="professionalism-img">
        ...
        <section class="mv-section">
            <div class="container">
                ...
                <div class="row mission-section">
                    ...
                    <div class="col-md-6">
                        <img class="img-fluid" src="img/mission.svg" alt="mission-img">
                    </div>
                </div>

                <div class="row vision-section">
                    <div class="col-md-6">
                        <img class="img-fluid" src="img/vision.svg" alt="vision-img">
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="container">
                            ...
                            <div class="contact-info-bottom">
                                <div class="contact-info pb-3">
                                    <img class="img-fluid" src="img/location.svg" height="30" width="30"   alt="mission-img">
                                ...
                                <div class="contact-info">
                                    <img class="img-fluid" src="img/phone.svg" height="30" width="30"   alt="mission-img">
    
                                    <a href="tel: 0464303485" class="info">046-430-3485</a>
                                </div>
    
                                <div class="contact-info pt-3">
                                    <img class="img-fluid" src="img/mail.svg" height="30" width="30"   alt="mission-img">
                        ...
                        <div class="container">
                            <form action="" method="post">
                                <div class="row py-3 g-3">
                                   ...
                                   <div class="col-md-12">
                                        <textarea name="" class="form-control" id="" cols="30" rows="5" placeholder="Message" aria-label="Message"></textarea>
                                    </div>

                                    <div class="col-md-12 btn-section">
                                        <button type="submit" class="btn btn-green" href="#" role="button">Submit</button>
                                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="copyright-text text-center">
                    <span class="text-warning">J. F. Rubber Phils., Inc.</span> &copy; <?php echo date('Y') ?? "2023" ?> | All Rights Reserved
                </p>
            </div>
        </div>
