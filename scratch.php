...
// Preloder
// Preloader will be visible until the document or files loaded
...
// Mobile Navbar
// Show the mobile navbar when clock menu button and hidden after click menu close button or overlay
